...
This repository follows the [AI Development Framework](README.md) v5.1.0.
...
- Ask before destructive actions, external messages, merges, or deployments. Publishing AI review findings and the ready-for-human comment on **this change's own PR** is in scope for `review` / remediation `build` — see [commands/review.md](commands/review.md).
